...
exports.getAllProjects=expressAsyncHandler(async(req,res)=>{
  try{
      ...
      let result=await Project.findAll({where:{project_manager:user.email,active:true},attributes:["project_id","project_name","client","client_account_manager","status","start_date","end_date","fitness_indicator"]
  })
